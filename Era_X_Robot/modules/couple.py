...
from Era_X_Robot import pbot
from Era_X_Robot.utils.mongo import get_couple, save_couple
...
__ɴᴇᴡ ᴄᴏᴜᴘʟᴇ ᴏғ ᴛʜᴇ ᴅᴀʏ ᴍᴀʏ ʙᴇ ᴄʜᴏsᴇɴ ᴀᴛ 𝟷𝟸ᴀᴍ {tomorrow}__"""
...
__ɴᴇᴡ ᴄᴏᴜᴘʟᴇ ᴏғ ᴛʜᴇ ᴅᴀʏ ᴄᴀɴ ʙᴇ ᴄʜᴏsᴇɴ ᴀᴛ 𝟷𝟸ᴀᴍ {tomorrow}__"""
            await pbot.send_message(message.chat.id, text=couple_selection_message)
