...
# from Era_X_Robot.modules.sql import warns_sql as warnssql
import Era_X_Robot.modules.sql.blacklist_sql as blacklistsql

# from Era_X_Robot.modules.sql import cust_filters_sql as filtersql
# import Era_X_Robot.modules.sql.welcome_sql as welcsql
import Era_X_Robot.modules.sql.locks_sql as locksql
import Era_X_Robot.modules.sql.notes_sql as sql

# from Era_X_Robot.modules.rules import get_rules
import Era_X_Robot.modules.sql.rules_sql as rulessql
from Era_X_Robot import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from Era_X_Robot.__main__ import DATA_IMPORT
from Era_X_Robot.modules.connection import connected
from Era_X_Robot.modules.helper_funcs.alternate import typing_action
from Era_X_Robot.modules.helper_funcs.chat_status import user_admin
from Era_X_Robot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("Era_X_Robot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Era_X_Robot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Era_X_Robot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Era_X_Robot{}.backup".format(chat_id))  # Cleaning file
