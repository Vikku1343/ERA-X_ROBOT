...
from Era_X_Robot import OWNER_ID, pbot
from Era_X_Robot.utils.admins import can_change_info
from Era_X_Robot.utils.errors import capture_err
from Era_X_Robot.utils.mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_upvote = r"^((?i)\+|\+\+|\+1|thx|thanx|thanks|🖤|❣️|💝|💖|💕|❤|💘|cool|good|👍|baby|Star|thank you|gud|thankyou|love|pro)$"
