...
from Era_X_Robot import telethn
from Era_X_Robot.events import register


@register(pattern="Star (.*)")
async def hmm(event):
    ...
    if "no no" in result:
        pro = "I am fairly found and I was made by @radhe_krishna_hare_hare."
        try:
