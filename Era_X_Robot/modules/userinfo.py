...
import Era_X_Robot.modules.sql.userinfo_sql as sql
...
from Era_X_Robot import telethn as StarTelethonClient
from Era_X_Robot.__main__ import STATS, TOKEN, USER_INFO
from Era_X_Robot.modules.disable import DisableAbleCommandHandler
from Era_X_Robot.modules.helper_funcs.chat_status import sudo_plus
from Era_X_Robot.modules.helper_funcs.extraction import extract_user
from Era_X_Robot.modules.sql.afk_sql import check_afk_status, is_afk
from Era_X_Robot.modules.sql.global_bans_sql import is_user_gbanned
from Era_X_Robot.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/Star_X_Network/308">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ᴅᴇᴠᴇʟᴏᴘᴇʀ", url="https://t.me/radhe_krishna_hare_hare"
                            ),
                            InlineKeyboardButton(
...
def stats(update: Update, context: CallbackContext):
    stats = "<b> ᴄᴜʀʀᴇɴᴛ sᴛᴀᴛs ᴏғ ησвι ✘ ʀᴏʙᴏᴛ:</b>\n" + "\n".join(
